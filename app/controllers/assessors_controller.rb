class AssessorsController < ApplicationController
  ...
  private
    ...
    def set_collections
      @roles = ["Presidente executivo", "Vice-Presidente", "Diretor Administrativo", "Diretor de Comunicação e Marketing", "Diretor de Desenvolvimento", "Presidente do Conselho deliberativo", "Outro"]
